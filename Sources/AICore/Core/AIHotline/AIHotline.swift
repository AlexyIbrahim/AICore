...
//        }
    ...
    public final class func addNotificationObserverFor(_ notificationName: Notification.Name, object: Any? = nil, _ closure: @escaping (Notification) -> Void) -> Any {
    ...
    public final class func addNotificationObserverFor(_ notificationName: Notification.Name, _ closure: @escaping () -> Void) -> Any {
        return addNotificationObserverFor(notificationName) { _ in
            closure()
        }
    }
...
extension AIHotline {
    ...
    @objc private func onKeyboardWillDisappear(_: NSNotification) {
    ...
    @objc private func onKeyboardDidDisappear(_: NSNotification) {
        keyboardDidHideCallBack?()
    }

    // screenshot
    @objc private func userDidTakeScreenshot(_: NSNotification) {
        userDidTakeScreenshot?()
    }

    // screen recording
    @objc private func screenCaptureDidChange(_: NSNotification) {
        if UIScreen.main.isCaptured {
            captureDidChange?(true)
        } else {
            captureDidChange?(false)
        }
    }
}
