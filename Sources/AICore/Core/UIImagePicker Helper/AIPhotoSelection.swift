...
public class AIPhotoSelection: NSObject {
    ...
    struct AlertButton {
        ...
        init(title: String, callback: (() -> ())? = nil, style: UIAlertAction.Style? = nil) {
            self.title = title
    ...
    var image_callback: ((UIImage) -> ())?
    
    public final class func selectImage(inViewController viewController: UIViewController, from source: UIImagePickerController.SourceType, image_callback: ((UIImage) -> ())? = nil) {
