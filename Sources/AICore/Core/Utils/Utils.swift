...
public class Utils {
    ...
    public final class func loadNibFile(nibName: String, from: AnyObject? = nil) -> UINib {
        let nib = UINib(nibName: nibName, bundle: (from != nil) ? Bundle(for: type(of: from!)) : nil)
        return nib
    }
    ...
    public final class func scheduleNotification(title: String, body: String? = nil, userInfo: [AnyHashable: Any]? = nil, delaySeconds: TimeInterval? = nil, successCallback: VoidClosure? = nil, errorCallback: ((_ error: Error) -> Void)? = nil) {
    ...
    public final class func playSound(filename: String, ext: String, volume: Float? = nil) {
        ...
        do {
            shared.avPlayer = try AVAudioPlayer(contentsOf: URL(fileURLWithPath: path), fileTypeHint: AVFileType.mp3.rawValue)

            guard let player = shared.avPlayer else { return }
    ...
    public final class func store(image: UIImage,
                                  ...
                                  callback: ((_ isSaved: Bool, _ path: String?, _ fileURL: URL?) -> Void)? = nil)
    {
    ...
    public final class func getImages(in folderName: String) -> [LocalImageModel]? {
        ...
        if fileManager.fileExists(atPath: folderURL.path) {
            do {
                ...
                return fileUrls.compactMap { LocalImageModel(image: UIImage(contentsOfFile: $0.path), url: $0) }
            } catch {
                print(error)
                return nil
            }
    ...
    public final class func downloadImage(imagePath: String, successCallback: ((_ uiimage: UIImage, _ imageData: Data, _ result: ImageLoadingResult) -> Void)? = nil, errorCallback: ((_ error: KingfisherError) -> Void)? = nil) {
        if let imageURL = URL(string: imagePath) {
            Utils.downloadImage(imageURL: imageURL, successCallback: successCallback, errorCallback: errorCallback)
        }
    }

    public final class func downloadImage(imageURL: URL, successCallback: ((_ uiimage: UIImage, _ imageData: Data, _ result: ImageLoadingResult) -> Void)? = nil, errorCallback: ((_ error: KingfisherError) -> Void)? = nil) {
    ...
    public final class func formatUrl(url: String) -> String {
        let pattern = "(?<!http:)//"
    ...
    public final class func decode<T>(model _: T.Type, from data: Data, dateFormat _: String? = nil) -> T? {
        do {
